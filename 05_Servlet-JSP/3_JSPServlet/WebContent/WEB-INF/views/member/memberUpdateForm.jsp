...
<%
	...
	if(!myInterest.equals("null")){
		String[] splitStr = myInterest.split(", "); // 넣은 형태에 따라 바뀔 수 있음
...
<%-- 			
// 				String[] interest = my.getInterest().split(", ");
--%>
// 			var my = document.getElementsByName('myInterest');
// 			for(var i = 0; i < my.length; i++){
// 				console.log(my[i].value);
