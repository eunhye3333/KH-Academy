	...
	<form action="bupdate.bo" method="post" enctype="Multipart/form-data">
		...
		<table id="boardUpdateTable" border="1">
			<tr>
				<th>제목</th>
				<td>
					<input type="text" size="80" name="boardTitle" value="${ b.boardTitle }">
				</td>
			</tr>
			<tr>
				<th>작성자</th>
				<td>
					<input type="text" name="boardWriter" readonly value="${ b.nickName }" style="background: lightgrey;">
				</td>
			</tr>
			<tr>
				<th>내용</th>
				<td><textarea rows="10" cols="80" name="boardContent">${ b.boardContent }</textarea></td>
			</tr>
			<tr>
				<th>첨부파일</th>
				<td>
